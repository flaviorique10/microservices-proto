...
const (
	ShippingService_GetDeliveryTime_FullMethodName = "/shipping.ShippingService/GetDeliveryTime"
)
...
type ShippingServiceClient interface {
	GetDeliveryTime(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error)
}
...
func (c *shippingServiceClient) GetDeliveryTime(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShippingResponse)
	err := c.cc.Invoke(ctx, ShippingService_GetDeliveryTime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	GetDeliveryTime(context.Context, *ShippingRequest) (*ShippingResponse, error)
...
func (UnimplementedShippingServiceServer) GetDeliveryTime(context.Context, *ShippingRequest) (*ShippingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDeliveryTime not implemented")
}
...
func _ShippingService_GetDeliveryTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShippingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).GetDeliveryTime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShippingService_GetDeliveryTime_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).GetDeliveryTime(ctx, req.(*ShippingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShippingService_GetDeliveryTime_Handler,
		},
	},
